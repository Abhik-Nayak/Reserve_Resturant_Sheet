...
import home from "../assets/webdeveloper.svg";
                ...
                <div className='md:flex items-center justify-between bg-white py-4 md:px-10 px-7'>
                    <div className='font-bold text-2xl cursor-pointer flex items-center font-[Poppins] text-gray-800'>
                        <span className='text-3xl text-indigo-600 mr-1 '>
                            <img src={logo} className="h-10 w-10 lg-none" />
                        </span>
                        <span className='text-[#0074cb]'>MERN</span>
                    </div>
                    ...
                    <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 opacity-100' : 'top-[-490px]'}`}>
                        ...
                        <button className='bg-blue-500 text-white font-[Poppins] py-2 px-6 rounded md:ml-8 hover:bg-[#2699fb] duration-500'>
                            <Link to="/login">
                                Get Started
                            </Link>
                        </button>
