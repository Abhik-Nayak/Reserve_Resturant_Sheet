        ...
        <section className='max-w-7xl mx-auto'>
            <div>
                ...
                <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
                    Browse through a collection og imaginative and visually stunning images generated by JAPS AI
                </p>
            </div>
            <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
                <div className='flex flex-col gap-5'>
                    ...
                    <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
                        ...
                        {generatingImg && (
                            <div className='absolute inset-0 z-0 flex justify-center items-center items-center bg-[rgba(0,0,0,0.5)] rounded-lg'>
                                {/* <div className='absolute bg-[rgba(0,0,0,0.5)]'> */}
                                <Loader />
                            </div>
                        )}
                    </div>
