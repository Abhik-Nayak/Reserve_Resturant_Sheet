        ...
        <section className=" mt-10 min-h-screen flex items-center justify-center">
            ...
            <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                ...
                <div className="md:w-1/2 px-8 md:px-16">
                    ...
                    <p className="text-xs mt-4 text-blue-500">Create a new Account</p>

                    <form action="" className="flex flex-col gap-4">
                        <input className="p-2 mt-8 rounded-xl border" type="text" name="Firstname" placeholder="Fast Name" />
                        ...
                        <button className="bg-blue-500 rounded-xl text-white py-2 uppercase hover:scale-105 duration-300">Create</button>
                    </form>
                </div>
